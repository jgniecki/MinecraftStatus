...
if ($query->isConnected()) {
    ...
    print_r($query->getInfo()); //When the table is empty, it probably failed to communicate properly with the server. Previously, a ReceiveStatusException exception was thrown
